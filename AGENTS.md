...
- Current Etsy listing media capacity is up to **20 listing images and 2 listing videos**. Do not assume the old 10-image cap. Before replacing an existing image just because a listing has 10 images, check the live image count first; ranks 11-20 are valid. Etsy listing videos are short (3-15 seconds) and Etsy strips audio on upload.
